...
| **Profilo utente** | Avatar, statistiche personali e sfide create |
...
| **Validazione & API docs** | Zod · Swagger (OpenAPI) |
| **Logging** | Pino |
...
I test Playwright girano su Chromium, Firefox, WebKit, Microsoft Edge, Google Chrome e emulazione mobile (Pixel 5, iPhone 12).
